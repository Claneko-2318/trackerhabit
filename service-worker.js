...
const APP_SHELL = [
  ...
  './styles-v58.css?v=58',
  './mobile.css?v=57',
  './mobile-v57-fixes.css?v=57',
  './mobile-v58-fixes.css?v=58',
  './pwa.css?v=46',
  ...
  './apple-touch-icon-v48.png',
  './icons/app-screen-icon-192-v48.png',
  './icons/app-screen-icon-512-v48.png',
  './icons/app-screen-icon-maskable-192-v48.png',
  './icons/app-screen-icon-maskable-512-v48.png',
  './icons/icon-192.png',
  './icons/icon-512.png',
